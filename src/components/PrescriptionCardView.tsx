...
import { getDateForComparison } from '../utils/dateFormat';

/**
 * PrescriptionCardView displays a single prescription in a card component
 * with basic information and a link to the detail page
 */
const PrescriptionCardView = ({ prescription }: PrescriptionCardProps) => {
...
export default memo(PrescriptionCardView); 