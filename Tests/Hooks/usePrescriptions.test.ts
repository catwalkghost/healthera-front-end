...
import { usePrescriptions } from '../../src/Lib/Hooks/usePrescriptions';
import * as prescriptionsApi from '../../src/Lib/API/prescriptions';
import mockPrescriptions from '../../src/Lib/API/prescriptions/prescriptionMocks';

// Mock the API module
vi.mock('../../src/Lib/API/prescriptions');
